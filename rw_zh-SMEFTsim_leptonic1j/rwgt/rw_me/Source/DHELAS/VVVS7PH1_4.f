...
C     
      SUBROUTINE VVVS7PH1_4(V1, V2, V3, COUP, M4, W4,S4)
      IMPLICIT NONE
      ...
      DENOM = COUP/(FCT2)
      S4(3)= DENOM*M4*MDL_DWH*(TMP17*(TMP18*TMP33-TMP19*TMP32)+(TMP20
     $ *(TMP19*TMP25-TMP21*TMP33)+(TMP22*(TMP21*TMP28-TMP18*TMP24)
     $ +TMP23*(TMP24*TMP32-TMP25*TMP28))))
      END
