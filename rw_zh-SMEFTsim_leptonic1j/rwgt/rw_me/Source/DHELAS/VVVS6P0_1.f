...
C     
      SUBROUTINE VVVS6P0_1(V2, V3, S4, COUP, M1, W1,V1)
      IMPLICIT NONE
      COMPLEX*16 CI
     ...
     $ * W1))
      V1(3)= DENOM*S4(3)*(TMP23*(-CI*(P2(0))+CI*(P3(0)))+(V2(3)*(-CI
     $ *(TMP18)+CI*(TMP19))+V3(3)*(-CI*(TMP22)+CI*(TMP20))))
      V1(4)= DENOM*S4(3)*(TMP23*(-CI*(P2(1))+CI*(P3(1)))+(V2(4)*(-CI
     $ *(TMP18)+CI*(TMP19))+V3(4)*(-CI*(TMP22)+CI*(TMP20))))
      V1(5)= DENOM*S4(3)*(TMP23*(-CI*(P2(2))+CI*(P3(2)))+(V2(5)*(-CI
     $ *(TMP18)+CI*(TMP19))+V3(5)*(-CI*(TMP22)+CI*(TMP20))))
      V1(6)= DENOM*S4(3)*(TMP23*(-CI*(P2(3))+CI*(P3(3)))+(V2(6)*(-CI
     $ *(TMP18)+CI*(TMP19))+V3(6)*(-CI*(TMP22)+CI*(TMP20))))
      END
