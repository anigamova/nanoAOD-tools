...
C     *P(-1,2)
C     
      SUBROUTINE VVSS2_3(V1, V2, S4, COUP, M3, W3,S3)
      IMPLICIT NONE
      COMPLEX*16 CI
      ...
      P3(2) = -DIMAG(S3(2))
      P3(3) = -DIMAG(S3(1))
      TMP26 = (-1D0)*(P1(0)*(P2(1)*(V2(5)*V1(6)-V2(6)*V1(5))+(P2(2)
     ...
     $ *V1(3)-V2(3)*V1(4)))))))
      TMP27 = (-1D0)*(P1(0)*(P2(1)*(V2(6)*V1(5)-V2(5)*V1(6))+(P2(2)
     ...
     $ * W3))
      S3(3)= DENOM*S4(3)*(-CI*(TMP26)+CI*(TMP27))
      END
