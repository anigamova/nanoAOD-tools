...
C     
     ...
     $ * W1))
      V1(3)= DENOM*(-2D0 )* CI * S3(3)*(P1(1)*(P2(3)*V2(5)-P2(2)*V2(6))
     $ +(P1(2)*(P2(1)*V2(6)-P2(3)*V2(4))+P1(3)*(P2(2)*V2(4)-P2(1)*V2(5)
     $ )))
      V1(4)= DENOM*2D0 * CI * S3(3)*(P1(0)*(P2(2)*V2(6)-P2(3)*V2(5))
     $ +(P1(2)*(P2(3)*V2(3)-P2(0)*V2(6))+P1(3)*(P2(0)*V2(5)-P2(2)*V2(3)
     $ )))
      V1(5)= DENOM*2D0 * CI * S3(3)*(P1(0)*(P2(3)*V2(4)-P2(1)*V2(6))
     $ +(P1(1)*(P2(0)*V2(6)-P2(3)*V2(3))+P1(3)*(P2(1)*V2(3)-P2(0)*V2(4)
     $ )))
      V1(6)= DENOM*2D0 * CI * S3(3)*(P1(0)*(P2(1)*V2(5)-P2(2)*V2(4))
