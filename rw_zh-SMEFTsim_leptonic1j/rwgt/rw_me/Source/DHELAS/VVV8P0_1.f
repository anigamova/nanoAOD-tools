...
C     
     ...
     $ * W1))
      V1(3)= DENOM*(-CI)*(P2(1)*(P3(2)*(-2D0)*(V3(6)*TMP20+V2(6)*TMP18
     $ +P1(3)*TMP23)+(P3(3)*2D0*(V3(5)*TMP20+V2(5)*TMP18+P1(2)*TMP23)
     $ +(TMP22*2D0*(V3(5)*P1(3)-V3(6)*P1(2))+2D0*(TMP32*(V3(5)*V2(6)
     $ -V3(6)*V2(5))))))+(P2(2)*(P3(1)*2D0*(V3(6)*TMP20+V2(6)*TMP18
     $ +P1(3)*TMP23)+(P3(3)*(-2D0)*(V3(4)*TMP20+V2(4)*TMP18+P1(1)
     $ *TMP23)+(TMP22*2D0*(V3(6)*P1(1)-V3(4)*P1(3))+2D0*(TMP32*(V3(6)
     $ *V2(4)-V3(4)*V2(6))))))+(P2(3)*(P3(1)*(-2D0)*(V3(5)*TMP20+V2(5)
     $ *TMP18+P1(2)*TMP23)+(P3(2)*2D0*(V3(4)*TMP20+V2(4)*TMP18+P1(1)
     $ *TMP23)+(TMP22*2D0*(V3(4)*P1(2)-V3(5)*P1(1))+2D0*(TMP32*(V3(4)
     $ *V2(5)-V3(5)*V2(4))))))+(TMP19*(P1(1)*2D0*(P3(3)*V2(5)-P3(2)
     $ *V2(6))+(P1(2)*2D0*(P3(1)*V2(6)-P3(3)*V2(4))+2D0*(P1(3)*(P3(2)
     $ *V2(4)-P3(1)*V2(5)))))+(TMP28*(P3(1)*2D0*(V3(5)*V2(6)-V3(6)
     $ *V2(5))+(P3(2)*2D0*(V3(6)*V2(4)-V3(4)*V2(6))+2D0*(P3(3)*(V3(4)
     $ *V2(5)-V3(5)*V2(4)))))+(TMP33*(P1(1)*2D0*(V3(5)*V2(6)-V3(6)
     $ *V2(5))+(P1(2)*2D0*(V3(6)*V2(4)-V3(4)*V2(6))+2D0*(P1(3)*(V3(4)
     $ *V2(5)-V3(5)*V2(4)))))+(V2(3)*(TMP50-TMP51)+(V3(3)*(TMP53-TMP52)
     $ +(+2D0*(P2(0)*TMP44+P3(0)*TMP45))))))))))
      V1(4)= DENOM*CI*(P2(0)*(P3(2)*2D0*(V3(6)*TMP20+V2(6)*TMP18+P1(3)
     $ *TMP23)+(P3(3)*(-2D0)*(V3(5)*TMP20+V2(5)*TMP18+P1(2)*TMP23)
     $ +(TMP22*2D0*(V3(6)*P1(2)-V3(5)*P1(3))+2D0*(TMP32*(V3(6)*V2(5)
     $ -V3(5)*V2(6))))))+(P2(2)*(P3(0)*(-2D0)*(V3(6)*TMP20+V2(6)*TMP18
     $ +P1(3)*TMP23)+(P3(3)*2D0*(V3(3)*TMP20+V2(3)*TMP18+P1(0)*TMP23)
     $ +(TMP22*2D0*(V3(3)*P1(3)-V3(6)*P1(0))+2D0*(TMP32*(V3(3)*V2(6)
     $ -V3(6)*V2(3))))))+(P2(3)*(P3(0)*2D0*(V3(5)*TMP20+V2(5)*TMP18
     $ +P1(2)*TMP23)+(P3(2)*(-2D0)*(V3(3)*TMP20+V2(3)*TMP18+P1(0)
     $ *TMP23)+(TMP22*2D0*(V3(5)*P1(0)-V3(3)*P1(2))+2D0*(TMP32*(V3(5)
     $ *V2(3)-V3(3)*V2(5))))))+(TMP19*(P1(0)*2D0*(P3(2)*V2(6)-P3(3)
     $ *V2(5))+(P1(2)*2D0*(P3(3)*V2(3)-P3(0)*V2(6))+2D0*(P1(3)*(P3(0)
     $ *V2(5)-P3(2)*V2(3)))))+(TMP28*(P3(0)*2D0*(V3(6)*V2(5)-V3(5)
     $ *V2(6))+(P3(2)*2D0*(V3(3)*V2(6)-V3(6)*V2(3))+2D0*(P3(3)*(V3(5)
     $ *V2(3)-V3(3)*V2(5)))))+(TMP33*(P1(0)*2D0*(V3(6)*V2(5)-V3(5)
     $ *V2(6))+(P1(2)*2D0*(V3(3)*V2(6)-V3(6)*V2(3))+2D0*(P1(3)*(V3(5)
     $ *V2(3)-V3(3)*V2(5)))))+(V2(4)*(TMP51-TMP50)+(V3(4)*(TMP52-TMP53)
     $ +(-2D0*(P2(1)*TMP44+P3(1)*TMP45))))))))))
      V1(5)= DENOM*CI*(P2(0)*(P3(1)*(-2D0)*(V3(6)*TMP20+V2(6)*TMP18
     $ +P1(3)*TMP23)+(P3(3)*2D0*(V3(4)*TMP20+V2(4)*TMP18+P1(1)*TMP23)
     $ +(TMP22*2D0*(V3(4)*P1(3)-V3(6)*P1(1))+2D0*(TMP32*(V3(4)*V2(6)
     $ -V3(6)*V2(4))))))+(P2(1)*(P3(0)*2D0*(V3(6)*TMP20+V2(6)*TMP18
     $ +P1(3)*TMP23)+(P3(3)*(-2D0)*(V3(3)*TMP20+V2(3)*TMP18+P1(0)
     $ *TMP23)+(TMP22*2D0*(V3(6)*P1(0)-V3(3)*P1(3))+2D0*(TMP32*(V3(6)
     $ *V2(3)-V3(3)*V2(6))))))+(P2(3)*(P3(0)*(-2D0)*(V3(4)*TMP20+V2(4)
     $ *TMP18+P1(1)*TMP23)+(P3(1)*2D0*(V3(3)*TMP20+V2(3)*TMP18+P1(0)
     $ *TMP23)+(TMP22*2D0*(V3(3)*P1(1)-V3(4)*P1(0))+2D0*(TMP32*(V3(3)
     $ *V2(4)-V3(4)*V2(3))))))+(TMP19*(P1(0)*2D0*(P3(3)*V2(4)-P3(1)
     $ *V2(6))+(P1(1)*2D0*(P3(0)*V2(6)-P3(3)*V2(3))+2D0*(P1(3)*(P3(1)
     $ *V2(3)-P3(0)*V2(4)))))+(TMP28*(P3(0)*2D0*(V3(4)*V2(6)-V3(6)
     $ *V2(4))+(P3(1)*2D0*(V3(6)*V2(3)-V3(3)*V2(6))+2D0*(P3(3)*(V3(3)
     $ *V2(4)-V3(4)*V2(3)))))+(TMP33*(P1(0)*2D0*(V3(4)*V2(6)-V3(6)
     $ *V2(4))+(P1(1)*2D0*(V3(6)*V2(3)-V3(3)*V2(6))+2D0*(P1(3)*(V3(3)
     $ *V2(4)-V3(4)*V2(3)))))+(V2(5)*(TMP51-TMP50)+(V3(5)*(TMP52-TMP53)
     $ +(-2D0*(P2(2)*TMP44+P3(2)*TMP45))))))))))
      V1(6)= DENOM*CI*(P2(0)*(P3(1)*2D0*(V3(5)*TMP20+V2(5)*TMP18+P1(2)
     $ *TMP23)+(P3(2)*(-2D0)*(V3(4)*TMP20+V2(4)*TMP18+P1(1)*TMP23)
     $ +(TMP22*2D0*(V3(5)*P1(1)-V3(4)*P1(2))+2D0*(TMP32*(V3(5)*V2(4)
     $ -V3(4)*V2(5))))))+(P2(1)*(P3(0)*(-2D0)*(V3(5)*TMP20+V2(5)*TMP18
     $ +P1(2)*TMP23)+(P3(2)*2D0*(V3(3)*TMP20+V2(3)*TMP18+P1(0)*TMP23)
     $ +(TMP22*2D0*(V3(3)*P1(2)-V3(5)*P1(0))+2D0*(TMP32*(V3(3)*V2(5)
     $ -V3(5)*V2(3))))))+(P2(2)*(P3(0)*2D0*(V3(4)*TMP20+V2(4)*TMP18
     $ +P1(1)*TMP23)+(P3(1)*(-2D0)*(V3(3)*TMP20+V2(3)*TMP18+P1(0)
     $ *TMP23)+(TMP22*2D0*(V3(4)*P1(0)-V3(3)*P1(1))+2D0*(TMP32*(V3(4)
     $ *V2(3)-V3(3)*V2(4))))))+(TMP19*(P1(0)*2D0*(P3(1)*V2(5)-P3(2)
     $ *V2(4))+(P1(1)*2D0*(P3(2)*V2(3)-P3(0)*V2(5))+2D0*(P1(2)*(P3(0)
     $ *V2(4)-P3(1)*V2(3)))))+(TMP28*(P3(0)*2D0*(V3(5)*V2(4)-V3(4)
     $ *V2(5))+(P3(1)*2D0*(V3(3)*V2(5)-V3(5)*V2(3))+2D0*(P3(2)*(V3(4)
     $ *V2(3)-V3(3)*V2(4)))))+(TMP33*(P1(0)*2D0*(V3(5)*V2(4)-V3(4)
     $ *V2(5))+(P1(1)*2D0*(V3(3)*V2(5)-V3(5)*V2(3))+2D0*(P1(2)*(V3(4)
     $ *V2(3)-V3(3)*V2(4)))))+(V2(6)*(TMP51-TMP50)+(V3(6)*(TMP52-TMP53)
     $ +(-2D0*(P2(3)*TMP44+P3(3)*TMP45))))))))))
      END
