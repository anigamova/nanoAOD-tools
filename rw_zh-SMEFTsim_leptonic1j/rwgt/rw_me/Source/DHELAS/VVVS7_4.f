...
C     
      SUBROUTINE VVVS7_4(V1, V2, V3, COUP, M4, W4,S4)
      IMPLICIT NONE
      COMPLEX*16 CI
     ...
     $ * W4))
      S4(3)= DENOM*(TMP17*(-CI*(TMP19*TMP32)+CI*(TMP18*TMP33))+(TMP20
     $ *(-CI*(TMP21*TMP33)+CI*(TMP19*TMP25))+(TMP22*(-CI*(TMP18*TMP24)
     $ +CI*(TMP21*TMP28))+TMP23*(-CI*(TMP25*TMP28)+CI*(TMP24*TMP32)))))
      END
