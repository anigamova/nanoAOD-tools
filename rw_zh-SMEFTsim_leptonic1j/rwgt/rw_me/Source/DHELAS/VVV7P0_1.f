...
C     
     ...
     $ * W1))
      V1(3)= DENOM*(P2(0)*(-CI*(TMP23*TMP32)+CI*(TMP18*TMP22))+(P3(0)
     $ *(-CI*(TMP19*TMP20)+CI*(TMP23*TMP28))+(TMP33*(-CI*(V2(3)*TMP18)
     $ +CI*(V3(3)*TMP20))+(-CI*(V3(3)*TMP22*TMP28)+CI*(V2(3)*TMP19
     $ *TMP32)))))
      V1(4)= DENOM*(P2(1)*(-CI*(TMP23*TMP32)+CI*(TMP18*TMP22))+(P3(1)
     $ *(-CI*(TMP19*TMP20)+CI*(TMP23*TMP28))+(TMP33*(-CI*(V2(4)*TMP18)
     $ +CI*(V3(4)*TMP20))+(-CI*(V3(4)*TMP22*TMP28)+CI*(V2(4)*TMP19
     $ *TMP32)))))
      V1(5)= DENOM*(P2(2)*(-CI*(TMP23*TMP32)+CI*(TMP18*TMP22))+(P3(2)
     $ *(-CI*(TMP19*TMP20)+CI*(TMP23*TMP28))+(TMP33*(-CI*(V2(5)*TMP18)
     $ +CI*(V3(5)*TMP20))+(-CI*(V3(5)*TMP22*TMP28)+CI*(V2(5)*TMP19
     $ *TMP32)))))
      V1(6)= DENOM*(P2(3)*(-CI*(TMP23*TMP32)+CI*(TMP18*TMP22))+(P3(3)
     $ *(-CI*(TMP19*TMP20)+CI*(TMP23*TMP28))+(TMP33*(-CI*(V2(6)*TMP18)
     $ +CI*(V3(6)*TMP20))+(-CI*(V3(6)*TMP22*TMP28)+CI*(V2(6)*TMP19
     $ *TMP32)))))
      END
