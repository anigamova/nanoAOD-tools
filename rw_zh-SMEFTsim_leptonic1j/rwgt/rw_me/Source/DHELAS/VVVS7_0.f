...
C     
      ...
      VERTEX = COUP*S4(3)*(TMP17*(-CI*(TMP18*TMP33)+CI*(TMP19*TMP32))
     $ +(TMP20*(-CI*(TMP19*TMP25)+CI*(TMP21*TMP33))+(TMP22*(-CI*(TMP21
     $ *TMP28)+CI*(TMP18*TMP24))+TMP23*(-CI*(TMP24*TMP32)+CI*(TMP25
     $ *TMP28)))))
      END
