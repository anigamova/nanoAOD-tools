...
C     
     ...
     $ * W4))
      S4(3)= DENOM*(TMP65*(TMP21*(-CI*(TMP30+TMP28)+CI*(TMP33+TMP14))
     $ +(TMP18*(+CI*(TMP66)+2D0 * CI*(TMP24))+(TMP19*(-1D0)*(+CI
     $ *(TMP66)+2D0 * CI*(TMP25))+TMP67*(-CI*(TMP25)+CI*(TMP24)))))
     $ +(TMP17*(TMP67*(-CI*(TMP31+TMP33)+CI*(TMP30+TMP32))+(TMP14*(-CI
     $ *(TMP18)+CI*(TMP19))+(-2D0 * CI*(TMP18*TMP31)+2D0 * CI*(TMP19
     $ *TMP30))))+(TMP23*(TMP66*(-CI*(TMP32+TMP14)+CI*(TMP28+TMP31))
     $ +(TMP24*(-1D0)*(+CI*(TMP30)+2D0 * CI*(TMP14))+TMP25*(+CI*(TMP30)
     $ +2D0 * CI*(TMP31))))+(TMP20*(TMP21*(+CI*(TMP31)+2D0 * CI*(TMP14)
     $ )+(TMP66*(-1D0)*(+CI*(TMP67)+2D0 * CI*(TMP19))-2D0 * CI*(TMP25
     $ *TMP67)))+TMP22*(TMP21*(-1D0)*(+CI*(TMP31)+2D0 * CI*(TMP30))
     $ +(TMP66*(+CI*(TMP67)+2D0 * CI*(TMP18))+2D0 * CI*(TMP24*TMP67))))
     $ )))
      END
